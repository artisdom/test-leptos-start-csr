...
use crate::pages::page9::Page9;
use crate::pages::page10::Page10;
use crate::pages::page11::Page11;
    ...
    view! {
        ...
        <Router>
            <Routes>
                ...
                <Route path="/page9" view=Page9/>
                <Route path="/page10" view=Page10/>
                <Route path="/page11" view=Page11/>
